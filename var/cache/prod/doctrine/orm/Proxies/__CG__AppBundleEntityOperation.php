 ...
 */
class Operation extends \AppBundle\Entity\Operation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'sujet', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'dateDebut', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'dateFin', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'pieces', '' . "\0" . 'AppBundle\\Entity\\Operation' . "\0" . 'noteTech'];
        }
    ...
    public function setNoteTech($noteTech)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNoteTech', [$noteTech]);

        return parent::setNoteTech($noteTech);
    }
    ...
    public function getNoteTech()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNoteTech', []);

        return parent::getNoteTech();
    }
