 ...
 */
class Vehicule extends \AppBundle\Entity\Vehicule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Vehicule' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Vehicule' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Vehicule' . "\0" . 'dateAchat', '' . "\0" . 'AppBundle\\Entity\\Vehicule' . "\0" . 'operation'];
        }
