...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\GestionnaireType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\GestionnaireType']) ? $this->services['AppBundle\\Form\\GestionnaireType'] : ($this->services['AppBundle\\Form\\GestionnaireType'] = new \AppBundle\Form\GestionnaireType())) && false ?: '_'};
}, 'AppBundle\\Form\\OperationType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\OperationType']) ? $this->services['AppBundle\\Form\\OperationType'] : ($this->services['AppBundle\\Form\\OperationType'] = new \AppBundle\Form\OperationType())) && false ?: '_'};
}, 'AppBundle\\Form\\PieceType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\PieceType']) ? $this->services['AppBundle\\Form\\PieceType'] : ($this->services['AppBundle\\Form\\PieceType'] = new \AppBundle\Form\PieceType())) && false ?: '_'};
}, 'AppBundle\\Form\\TechnicienType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\TechnicienType']) ? $this->services['AppBundle\\Form\\TechnicienType'] : ($this->services['AppBundle\\Form\\TechnicienType'] = new \AppBundle\Form\TechnicienType())) && false ?: '_'};
}, 'AppBundle\\Form\\VehiculeType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\VehiculeType']) ? $this->services['AppBundle\\Form\\VehiculeType'] : ($this->services['AppBundle\\Form\\VehiculeType'] = new \AppBundle\Form\VehiculeType())) && false ?: '_'};
